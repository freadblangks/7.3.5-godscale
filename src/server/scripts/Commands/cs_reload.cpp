...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "hotfixes",                      rbac::RBAC_PERM_COMMAND_RELOAD_HOTFIXES,                         true,  &HandleReloadHotfixesCommand,                   "" },
        };
    ...
    {
     //Load hotfix_data table
        TC_LOG_INFO("misc", "Reloading hotfixes...");
        handler->SendGlobalGMSysMessage("Please wait, hotfixes are reloading...");
     ...
     //Reloading DB2
        ...
        sItemSparseStore.LoadStringsFromDB(2);
        ...
        for (HashMapHolder<Player>::MapType::const_iterator itr = m.begin(); itr != m.end(); ++itr)
            ...
            handler->SendGlobalGMSysMessage("Hotfixes are reloaded, with pleasure!");
